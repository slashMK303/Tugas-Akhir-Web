...
<body class="bg-amber-50 font-sans antialiased">
    ...
    <div class="min-h-screen flex items-center justify-center pt-20 pb-10">
        <div class="bg-amber-950/90 p-6 md:p-12 rounded-xl shadow-lg w-full max-w-2xl space-y-6 text-amber-50">
            <h2 class="text-3xl font-extrabold text-center mb-6">Dashboard Admin</h2>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <a href="kelola_barang.php" class="
                    p-6 bg-amber-800 rounded-lg shadow-md hover:bg-amber-700
                    flex flex-col items-center justify-center text-center
                    transition duration-300 ease-in-out transform hover:scale-105
                ">
                    <i class="fas fa-boxes text-4xl mb-3 text-amber-300"></i>
                    <span class="text-xl font-semibold">Kelola Barang</span>
                </a>

                <a href="kelola_pegawai.php" class="
                    p-6 bg-amber-800 rounded-lg shadow-md hover:bg-amber-700
                    flex flex-col items-center justify-center text-center
                    transition duration-300 ease-in-out transform hover:scale-105
                ">
                    <i class="fas fa-users-cog text-4xl mb-3 text-amber-300"></i>
                    <span class="text-xl font-semibold">Kelola Pegawai</span>
                </a>

                <a href="laporan.php" class="
                    col-span-full p-6 bg-amber-800 rounded-lg shadow-md hover:bg-amber-700
                    flex flex-col items-center justify-center text-center
                    transition duration-300 ease-in-out transform hover:scale-105
                ">
                    <i class="fas fa-chart-line text-4xl mb-3 text-amber-300"></i>
                    <span class="text-xl font-semibold">Laporan Penjualan</span>
                </a>
            </div>
        </div>
    </div>
