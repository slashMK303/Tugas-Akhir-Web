...
<body class="bg-amber-50 font-sans antialiased">
    ...
    <div class="min-h-screen flex items-center justify-center pt-20 pb-10">
        <div class="bg-amber-950/90 p-6 md:p-12 rounded-xl shadow-lg w-full max-w-2xl space-y-6 text-amber-50">
            <h2 class="text-3xl font-extrabold text-center mb-6">Dashboard Pembeli</h2>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
                <a href="../lihat_barang.php" class="
                ...
                ">
                    ...
                    <span class="text-xl font-semibold">Lihat Barang</span>
                </a>
                ...
                <a href="keranjang.php" class="
                    ...
                    transition duration-300 ease-in-out transform hover:scale-105
                ">
                    <i class="fas fa-shopping-cart text-4xl mb-3 text-amber-300"></i>
                    <span class="text-xl font-semibold">Keranjang Belanja</span>
                </a>
                ...
                ">
                    ...
                    <span class="text-xl font-semibold">Riwayat Pembelian</span>
                </a>
            </div>
        </div>
    </div>
