...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
            <a href="/lihat_barang.php" class="p-4 bg-blue-100 rounded shadow hover:bg-blue-200 text-center col-span-3">Lihat Barang</a>
            <a href="riwayat.php" class="p-4 bg-blue-100 rounded shadow hover:bg-blue-200 text-center col-span-3">Riwayat Pesanan</a>
        </div>
    </div>
